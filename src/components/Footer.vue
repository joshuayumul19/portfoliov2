<template>
	<footer class="mx-auto max-w-[63rem] px-4 mt-14" role="contentinfo">
		<div class="text-gray-400 flex gap-8 justify-center">
			...
			<a data-tooltip-target="githubProfile" href="https://github.com/joshuayumul19" target="_blank" class="p-2 hover:bg-slate-200 rounded" aria-label="GitHub Profile">
				<font-awesome-icon icon="fa-brands fa-github" size="xl" />
			</a>
		</div>
		<p class="text-gray-400 text-center mt-5">Built by Joshua B. Yumul</p>
	</footer>
</template>
